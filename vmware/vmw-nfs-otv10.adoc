...
image:vmware-nfs-otv10-029.png[otv10 architecture]
...
+
image:vmware-nfs-otv10-001.png[Choose to create new port group]
+
{nbsp}
...
+
image:vmware-nfs-otv10-003.png[Start add networking wizard]
+
{nbsp}
...
+
image:vmware-nfs-otv10-004.png[Choose target port group]
+
{nbsp}
...
+ 
image:vmware-nfs-otv10-005.png[VMkernel IPv4 settings]
+
{nbsp}
. Review the your selections on the *Ready to complete* page and click on *Finish* to create the VMkernel adapter.
+
image:vmware-nfs-otv10-006.png[Review VMkernel selections]
====
...
+
image:vmware-nfs-otv10-007.png[Deploy OVF Template...]
+
{nbsp}
...
+
image:vmware-nfs-otv10-008.png[Select OVA file]
+
{nbsp}
. On the Select network page select the network used for management traffic.
+
image:vmware-nfs-otv10-009.png[Select network]
+
{nbsp}
...
+
image:vmware-nfs-otv10-010.png[Select network]
+
{nbsp}
...
+
image:vmware-nfs-otv10-011.png[Customize OTV template 1]
+
image:vmware-nfs-otv10-012.png[Customize OTV template 2]
+
{nbsp}
...
+
image:vmware-nfs-otv10-014.png[Getting started]
+
{nbsp}
...
+
image:vmware-nfs-otv10-015.png[Add storage backend]
+
{nbsp}
. On the *Add Storage Backend* box, fill out the credentials for the ONTAP storage system.
+
image:vmware-nfs-otv10-016.png[Add storage backend]
+
{nbsp}
...
+
image:vmware-nfs-otv10-026.png[Storage page]
+
{nbsp}
...
+
image:vmware-nfs-otv10-027.png[Storage attributes page]
+
{nbsp}
. Finally, review the *Summary* and click on Finish to begin creating the NFS datastore.
+
image:vmware-nfs-otv10-028.png[Review summary and finish]
====
...
// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vmware_nfs_otv10.adoc
