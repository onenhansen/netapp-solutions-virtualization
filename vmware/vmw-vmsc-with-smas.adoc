...
image:vmware-vmsc-with-smas-001.png[vMSC with SnapMirror active sync architecture]
...
image:vmware-vmsc-with-smas-002.png[vMSC Uniform vs Non-Uniform host access mode]
...
image:vmware-vmsc-with-smas-004.png[System Manager iSCSI Lifs]
. On vSphere host iSCSI Storage Adapter, add that iSCSI IP under the Dynamic Discovery tab.
image:vmware-vmsc-with-smas-003.png[Add iSCSI server for dynamic discovery]
+
...
image:vmware-vmsc-with-smas-005.png[iSCSI connection info]
...
image:vmware-vmsc-with-smas-006.png[Create LUN with AutomatedFailOverDuplex]
...
image:vmware-vmsc-with-smas-009.png[SAN initiator group]
+
...
image:vmware-vmsc-with-smas-014.png[CG protection policy]


== vMSC uniform host access mode with ONTAP Tools.

. Ensure NetApp ONTAP Tools is deployed and registered to vCenter. 
image:vmware-vmsc-with-smas-015.png[ONTAP Tools Plug-in registered to vCenter]
...
image:vmware-vmsc-with-smas-016.png[Registered storage backends]
...
. Update hosts data to sync with ONTAP Tools and then, link:https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/configure/create-datastore.html[create a datastore].
image:vmware-vmsc-with-smas-017.png[Update hosts data]
...
image:vmware-vmsc-with-smas-018.png[Protect Cluster]
...
image:vmware-vmsc-with-smas-019.png[Add SnapMirror Relationship]
...
image:vmware-vmsc-with-smas-020.png[Add Relationship]
...
image:vmware-vmsc-with-smas-021.png[iSCSI Multipath info]
...
image:vmware-vmsc-with-smas-022.png[Volume protection status]
...
image:vmware-vmsc-with-smas-023.png[Host cluster relationships]
...
image:vmware-vmsc-with-smas-033.png[Three site topology]

image:vmware-vmsc-with-smas-024.png[Three site topology with async failover]
...
image:vmware-vmsc-with-smas-025.png[Register storage arrays]
...
image:vmware-vmsc-with-smas-028.png[SCV Dashboard]
image:vmware-vmsc-with-smas-029.png[Resource Backup info for Datastore]
image:vmware-vmsc-with-smas-030.png[Resource Backup info for VM]
...
image:vmware-vmsc-with-smas-031.png[VM restore location options]
. Similar option is also available for Datastore mount operation.
image:vmware-vmsc-with-smas-032.png[Datastore restore location options]
...
// NetApp Solutions restructuring (jul 2025) - renamed from vmware/vmware-vmsc-with-smas.adoc
