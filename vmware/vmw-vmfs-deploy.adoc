...
For more details, please visit link:https://docs.netapp.com/us-en/netapp-solutions-cloud/vmware/vmw-hybrid-dr-vmfs.html[DR using BlueXP DRaaS for VMFS Datastores^]
