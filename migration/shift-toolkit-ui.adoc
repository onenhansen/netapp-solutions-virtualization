...
image:shift-toolkit-018.png["Figure showing input/output dialog or representing written content"]

Accept the legal EULA by clicking on "Accept and Continue".

image:shift-toolkit-019.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-020.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-021.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-022.png["Figure showing input/output dialog or representing written content"]

** ONTAP Storage system credentials

image:shift-toolkit-023.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-024.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-025.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-026.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-027.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-028.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-029.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-030.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-031.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-032.png["Figure showing input/output dialog or representing written content"]
+ 
NOTE: The datastore dropdown in this context will only show NFSv3 datastores. NFSv4 datastores will not be displayed.
+
image:shift-toolkit-033.png["Figure showing input/output dialog or representing written content"]

. Update the migration details by selecting "Destination Site", Destination Hyper-V entry" and Datastore to Qtree mapping. 
+
image:shift-toolkit-034.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:shift-toolkit-035.png["Figure showing input/output dialog or representing written content"]

. Click on "Create Resource Group".
+
image:shift-toolkit-036.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:shift-toolkit-037.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-038.png["Figure showing input/output dialog or representing written content"]

. Select Resource Group Details and click on "Continue"
+
image:shift-toolkit-039.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-040.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:shift-toolkit-041.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-042.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-043.png["Figure showing input/output dialog or representing written content"]
...
+
image:shift-toolkit-044.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:shift-toolkit-045.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:shift-toolkit-046.png["Figure showing input/output dialog or representing written content"]
+
* For Linux-based VMs, the default location where the preparation scripts are stored is /NetApp and the /opt directory.
+
image:shift-toolkit-047.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:shift-toolkit-048.png["Figure showing input/output dialog or representing written content"]
+
image:shift-toolkit-049.png["Figure showing input/output dialog or representing written content"]
+
...
image:shift-toolkit-076.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-077.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-078.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-079.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-080.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-081.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-082.png["Figure showing input/output dialog or representing written content"]
...
image:shift-toolkit-083.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from vm-migrate/shift-toolkit-ui.adoc
