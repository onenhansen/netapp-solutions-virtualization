...
[.lead]
The NetApp Shift Toolkit is a standalone product designed to simplify and accelerate VM migrations across hypervisors, such as VMware ESXi and Microsoft Hyper-V.  It also supports disk-level conversions between various virtual disk formats.
